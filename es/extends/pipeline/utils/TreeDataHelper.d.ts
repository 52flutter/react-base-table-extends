import { AbstractTreeNode } from './utils';
...
export default class TreeDataHelper<N extends AbstractTreeNode> {
    ...
    isIndeterminate(nodeValue: string): boolean | undefined;
    isChecked(nodeValue: string): boolean | undefined;
    ...
    getNode(nodeValue: string): N | undefined;
