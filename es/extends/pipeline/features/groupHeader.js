...
import { collectNodes, makeRecursiveMapper } from '../utils/utils';
...
export var TreeUtils = /*#__PURE__*/function () {
  function TreeUtils() {
...
export function groupHeader(opts) {
  return function (pipeline) {
    ...
    if (columns.find(function (p) {
      ...
      var flatColumns = collectNodes(columns);

      var _padding = (opts === null || opts === void 0 ? void 0 : opts.cellPadding) || 7.5;

      var colTreeInfo = {};
      pipeline.mapColumns(makeRecursiveMapper(function (col, args) {
      ...
      var headerRenderer = function headerRenderer(_ref) {
        ...
        var renderTreeLevel = function renderTreeLevel(tree, level, maxLevel, columnIndex, headerIndex) {
          ...
          if (columnLevel < headerIndex) {
            ...
            groupCells.push( /*#__PURE__*/React.createElement("div", {
              key: column.key,
          ...
          nodes.map(function (item) {
            ...
            if ((_item$children2 = item.children) === null || _item$children2 === void 0 ? void 0 : _item$children2.length) {
              ...
              groupCells.push( /*#__PURE__*/React.cloneElement(cells[realColumnIndex], {
      ...
      pipeline.columns(collectNodes(columns, 'leaf-only')); // headerHeight: Array.from(Array(maxLevel + 1), (v, k) => headHeight),
