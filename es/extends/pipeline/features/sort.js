...
import { collectNodes, isLeafNode, layeredSort, smartCompare, safeHeaderRender } from '../utils/utils';
...
function DefaultSortHeaderCell(_ref2) {
  ...
  }, children, /*#__PURE__*/React.createElement(SortIcon, {
    style: {
      userSelect: 'none',
      marginLeft: 2,
      flexShrink: 0
...
export function sort() {
  ...
  return function sortStep(pipeline) {
    ...
    function processDataSource(dataSource) {
      ...
      var sortColumnsMap = new Map(collectNodes(columns, 'leaf-only').filter(function (col) {
      ...
      function dfs(col) {
        ...
        if (sortable) {
          ...
          result.headerRenderer = function (arg) {
            return /*#__PURE__*/React.createElement(SortHeaderCell, {
