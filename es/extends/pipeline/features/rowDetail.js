...
import { always, flatMap, safeHeaderRender, safeRender } from '../utils/utils';
...
export function rowDetail() {
  ...
  return function rowDetailStep(pipeline) {
    ...
    var hasDetail = (_opts$hasDetail = opts.hasDetail) !== null && _opts$hasDetail !== void 0 ? _opts$hasDetail : always(true);
    ...
    return pipeline.data(flatMap(pipeline.getDataSource(), function (row, rowIndex) {
