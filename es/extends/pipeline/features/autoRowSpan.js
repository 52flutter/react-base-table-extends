...
export function autoRowSpan() {
  return function autoRowSpanStep(pipeline) {
    ...
    pipeline.mapColumns(makeRecursiveMapper(function (col, _ref) {
      var _col$features;
      ...
      for (var rowIndex = 0; rowIndex < dataSource.length; rowIndex++) {
        ...
        var value = safeGetValue(col, row, rowIndex);
      ...
      columns.map(function (col, spanIndex) {
        if (col === null || col === void 0 ? void 0 : col.getSpanRect) {
          ...
          if (rowSpan > 1 && cells[spanIndex]) {
            ...
            cells[spanIndex] = /*#__PURE__*/React.cloneElement(cell, {
              style: style,
              className: cx(cell === null || cell === void 0 ? void 0 : (_cell$props2 = cell.props) === null || _cell$props2 === void 0 ? void 0 : _cell$props2.className, 'table-span-cell')
            });
          }
        }
      });
