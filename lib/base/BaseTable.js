...
var BaseTable = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function BaseTable(props) {
    ...
    _this._handleColumnResize = (0, _utils.throttle)(_this._handleColumnResize.bind(_assertThisInitialized(_this)), RESIZE_THROTTLE_WAIT);
  ...
  _createClass(BaseTable, [{
    ...
    value: function renderExpandIcon(_ref) {
      ...
      return /*#__PURE__*/_react.default.createElement(ExpandIcon, _extends({
        depth: depth,
        expandable: expandable,
        expanded: expanded
      }, extraProps, {
    ...
    value: function renderRowCell(_ref3) {
      ...
      var cls = (0, _classnames.default)(this._prefixClass('row-cell'), cellCls, (_cn2 = {}, _defineProperty(_cn2, this._prefixClass('row-cell--align-center'), column.align === _Column.Alignment.CENTER), _defineProperty(_cn2, this._prefixClass('row-cell--align-right'), column.align === _Column.Alignment.RIGHT), _cn2));
      ...
      return /*#__PURE__*/_react.default.createElement(Tag, _extends({
        ...
        className: (0, _classnames.default)(cls, (rest || {}).className),
    ...
    value: function renderHeader(_ref5) {
      ...
      var className = (0, _classnames.default)(this._prefixClass('header-row'), headerClass, (_cn3 = {}, _defineProperty(_cn3, this._prefixClass('header-row--resizing'), !!this.state.resizingKey), _defineProperty(_cn3, this._prefixClass('header-row--customized'), headerRenderer), _cn3));
    ...
    value: function renderHeaderCell(_ref6) {
      ...
      var cls = (0, _classnames.default)(this._prefixClass('header-cell'), cellCls, (_cn4 = {}, _defineProperty(_cn4, this._prefixClass('header-cell--align-center'), column.align === _Column.Alignment.CENTER), _defineProperty(_cn4, this._prefixClass('header-cell--align-right'), column.align === _Column.Alignment.RIGHT), _defineProperty(_cn4, this._prefixClass('header-cell--sortable'), column.sortable), _defineProperty(_cn4, this._prefixClass('header-cell--sorting'), sorting), _defineProperty(_cn4, this._prefixClass('header-cell--resizing'), column.key === this.state.resizingKey), _cn4));
      ...
      return /*#__PURE__*/_react.default.createElement(Tag, _extends({
        ...
        sortOrder: sortOrder,
        className: (0, _classnames.default)(this._prefixClass('sort-indicator'), _defineProperty({}, this._prefixClass('sort-indicator--descending'), sortOrder === _SortOrder.default.DESC))
    ...
    value: function renderMainTable() {
      ...
      return /*#__PURE__*/_react.default.createElement(_GridTable.default, _extends({}, rest, this.state, {
...
BaseTable.defaultProps = {
  ...
  onColumnResizeEnd: _utils.noop // getCellProps: noop,
