...
exports.safeGetRowKey = safeGetRowKey;
exports.safeGetValue = safeGetValue;
exports.flatMap = flatMap;
exports.safeRender = safeRender;
exports.safeHeaderRender = safeHeaderRender;
...
function mergeCellProps(base, extra) {
  ...
  for (var _i = 0, _Object$keys = Object.keys(extra); _i < _Object$keys.length; _i++) {
    ...
    if (value === null) {
      ...
      if (key === 'className') {
        result[key] = (0, _classnames.default)(result[key], value);
      } else {
        result[key] = value;
      }
...
function safeRender(column, args) {
...
function safeHeaderRender(column, args) {
