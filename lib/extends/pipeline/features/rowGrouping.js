...
function rowGrouping() {
  ...
  return function (pipeline) {
    ...
    function processDataSource(input) {
      return (0, _utils.flatMap)(input, function (row) {
    ...
    function processColumns(columns) {
      ...
      var cellRenderer = function cellRenderer(args) {
        ...
        var content = (0, _utils.safeRender)(column, args);
      ...
      pipeline.appendTableProps('rowRenderer', function (args) {
        ...
        if (getGroupingMeta(rowData).isGroupHeader) {
          ...
          cells[colIndex] = /*#__PURE__*/_react.default.cloneElement(cells[colIndex], {
            style: style
          });
        ...
        if (item.key === colKey) {
          return _objectSpread(_objectSpread({}, item), {}, {
            ...
            headerRenderer: function headerRenderer(args) {
              ...
              }, (0, _utils.safeHeaderRender)(column, args));
            }
          });
        }
