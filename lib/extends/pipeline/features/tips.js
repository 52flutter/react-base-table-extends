...
var HeaderCellWithTips = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  .tip-icon-wrapper {\n    margin-left: 2px;\n    margin-right: 1px;\n  }\n\n  .tip-icon {\n    display: flex;\n    fill: currentColor;\n  }\n"])));
    ...
    return pipeline.mapColumns((0, _utils.makeRecursiveMapper)(function (col) {
      ...
      return _objectSpread(_objectSpread({}, col), {}, {
        headerRenderer: function headerRenderer(args) {
          return /*#__PURE__*/_react.default.createElement(Tooltip, null, (0, _utils.safeHeaderRender)(col, args)); // if (typeof col.features.tips !== 'string') {
        ...
        cellRenderer: function cellRenderer(args) {
          return /*#__PURE__*/_react.default.createElement(Tooltip, null, (0, _utils.safeRender)(col, args));
        }
      });
    }));
  };
